...
import { Title, TitleImages, SubTitleImages, Hr, Card, TitleCard, WrapperButtons, Cadastrar } from './cadastro-arte.styled'

import { SaveProduto } from '../../../utils/services/cadastro/cadastro-produtos.service'


var array = [1]
export default class CadastroArte extends Component{
  state = {
    titulo: null,
    autor: null,
    descricao: null,
